...
u_csv = "/nvtest/GPU-Accelerated_Portfolio_Optimization/stocks_return_original_2022.csv"
cov_csv = "/nvtest/GPU-Accelerated_Portfolio_Optimization/cov_41_41.csv"
expo_csv = "/nvtest/GPU-Accelerated_Portfolio_Optimization/expo_4558_41.csv"
os.environ["MOSEKLM_LICENSE_FILE"] = "/nvtest/mosek_lic/mosek.lic"
industry_labels_fname = "/nvtest/GPU-Accelerated_Portfolio_Optimization/industry_labels.csv"

if __name__ == '__main__':
    mu = np.loadtxt(u_csv)
    cov = np.loadtxt(cov_csv,delimiter=",")
    expo = np.nan_to_num(np.loadtxt(expo_csv, delimiter=","))
    n = expo.shape[0]
    ...
    industry_labels = np.loadtxt(industry_labels_fname, dtype=np.int32)

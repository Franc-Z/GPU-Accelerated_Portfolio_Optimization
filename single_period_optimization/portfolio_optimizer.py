...
def load_data():
    ...
    return_ratio = np.loadtxt('/nvtest/single_period_optimization/returns_2022.csv', dtype=MyFloat)
...
def test_4558():
    ...
    return_ratio_new = np.loadtxt("/nvtest/single_period_optimization/returns_2023.csv", dtype=MyFloat)
